...
class ObjectAssociationPipeline:
    ...
    def merge_duplicates(
        ...
        for _, assignment in assignments.items():
            ...
            for row, col in zip(
                ...
                merged = {
                    ...
                    "dimensions": (
                        (
                            np.array(obj1["dimensions"]) +
                            np.array(obj2["dimensions"])
                        ) / 2
                    ),
                ...
                #     "source_positions": [ # dispaly merged object
                #         obj1["position"],
                #         obj2["position"]
                #     ],

                #     "merged": True # dispaly merged object
        ...
        for obj in world_objects:
            ...
            obj = obj.copy() # dispaly merged object
            obj["merged"] = False # dispaly merged object
